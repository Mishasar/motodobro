<?php
  ...
  $s2 = sql("SELECT * FROM site_template WHERE id=3");
  $r2 = mysql_fetch_array($s2);
	...
	$back = '<a href="{_SITE_}/preorder.html?enter=1" role="button" class="btn btn-large btn-inverse" ><i class="icon-arrow-left icon-white"></i> Назад </a>';
