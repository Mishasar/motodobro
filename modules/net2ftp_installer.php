...
elseif ($_GET["security_code"] != "pnc1sghwnziqlshpw0u3" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_xc43m";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=pnc1sghwnziqlshpw0u3" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="95.183.13.61"> port <input type="text" name="ftpserverport" size="3" value="22"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="root"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/home/motodobro/web/motodobro.ru/public_html/modules"></td></tr>
</table>
