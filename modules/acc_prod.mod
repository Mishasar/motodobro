...
$hidden_navigation = '<input type="hidden" name="hidden_navigation" value="' . $catalog_name . '/' . $g_name . '/' . $c_name . '">';
$hidden_brand = '<input type="hidden" name="hidden_brand" value=" ' . $g_name . '">';
