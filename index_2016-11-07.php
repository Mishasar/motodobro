...
$tpl -> define_dynamic ( "enter_no_reg", "header" );					   
  ...
  $title = 'МотоДобро - доставка мотозапчастей со всего мира!';
  ...
  $meta_descr = 'Мотозапчасти на заказ со всего мира, доставка по России и странам СНГ в кратчайшие сроки!';
