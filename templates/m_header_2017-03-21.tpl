        <div class="header">
			<div class="nav">
				<div class="wrapper js-scroll-menu">
					...
					<div class="nav_item">
					  ...
					  <a class="btn pull-right" href="{_SITE_}/reg2.html?enter=enter" style="margin-left:6px;"><i class="icon-key icon-white"></i> Регистрация</a>
			...
			<div class="wrapper cl" style="padding-bottom:10px;">
				...
				<div class="span3" style="padding-top:30px;padding-right:10px;">
					<div class="header_center">
						Режим работы: Пн-Пт: 10:00-19:00 <br>Эл. адрес: info@motodobro.ru <br>Телефон: +7 909 778 7073
					</div>
				</div>
				<div class="span4">
	...
	<form class="form-horizontal" action="{auth_form_action}" method="post" style="margin:0px;">
	  ...
	  <div class="control-group">
		...
		<div class="alert alert-info">
			...
			<p>Если Вы еще не зарегистрировались на нашем сайте, пройдите, пожалуйста, <a href="{_SITE_}/register_.html" class="m_model" style="color: #ee641b;">процедуру регистрации</a>. Она займет не более минуты.</p>      
		</div>		  
  </div>
