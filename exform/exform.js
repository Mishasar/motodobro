(function($){
 ...
 jQuery.fn.exform = function(options){
  ...
  function show_form(data){ 
   ...
   if($(exform_wrpr +'.finmsg p').length > 0) setTimeout(remove_form, 500)
  }
  ...
  function operations(){ 
   if( $(exform_wrpr +' form[name="exform"]').length > 0){
    ...
    $(exform_wrpr +' .exform_bg, .exform_wrapper.'+ options.theme +' .mf_submit input[type="button"]').click(remove_form);
